...
left join users
on post.author = users.userName
where users.userName = '$authorName'
";

$result = mysqli_query($connection, $query) or die("show query of the author  is not working porplery " . mysqli_errno($connection) . mysqli_error($connection));
